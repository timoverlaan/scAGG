...
# Note by scAGG authors (Timo Verlaan, 2025): 
#   The following code is modified a bit compared to the original code from:
...
def compute_lisi(
    ...
    if verbose:
        print("[LISI] Computing KNN graph")
    knn = NearestNeighbors(n_neighbors = perplexity * 3, algorithm = 'kd_tree', n_jobs=n_jobs).fit(X)
